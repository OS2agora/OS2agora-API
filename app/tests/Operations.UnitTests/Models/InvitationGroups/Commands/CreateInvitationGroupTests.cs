...
{
    public class CreateInvitationGroupTests : ModelsTestBase<CreateInvitationGroupCommand, InvitationGroup>
    {
        public CreateInvitationGroupTests()
        {
        ...
        [Test]
        public async Task CreateInvitationGroup_Administrator_Should_Not_Throw_Error()
        {
            SecurityExpressionRoot
                .Setup(x => x.HasRole(It.IsAny<string>()))
                .Returns((string param) => param == Security.Roles.Administrator);

            var request = new CreateInvitationGroupCommand();
        ...
        [TestCase("")]
        [TestCase(null)]
        public void CreateInvitationGroup_NotAdministrator_Should_Throw_Error(params string[] roleToTest)
        {
            SecurityExpressionRoot
                .Setup(x => x.HasRole(It.IsAny<string>()))
