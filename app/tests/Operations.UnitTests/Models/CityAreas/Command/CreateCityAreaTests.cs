...
{
    public class CreateCityAreaTests : ModelsTestBase<CreateCityAreaCommand, CityArea>
    {
        public CreateCityAreaTests()
        {
        ...
        [TestCase("RandomRole")]
        [TestCase(null)]
        public async Task CreateCityArea_HasRole(string roleToTest)
        {
            ...
            var request = new CreateCityAreaCommand();
            if (!shouldSucceedPre)
            {
                FluentActions
                    .Invoking(() =>
