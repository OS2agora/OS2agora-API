...
public class UpdateInviteesFromExcelFileCommandTests : ModelsTestBase<UpdateInviteesFromExcelFileCommand, MetaDataResponse<Hearing, InvitationMetaData>>
{
    public UpdateInviteesFromExcelFileCommandTests()
    {
    ...
    [Test]
    public async Task UpdateInviteesFromExcelFile_HearingOwner_Should_Not_Throw_Error()
    {
        SecurityExpressionsMock.Setup(x => x.IsHearingOwnerByHearingId(It.IsAny<int>()))
            .Returns(true);

        var request = new UpdateInviteesFromExcelFileCommand();
    ...
    [Test]
    public void UpdateInviteesFromExcelFile_NotHearingOwner_Throws_Error()
    {
        SecurityExpressionsMock.Setup(x => x.IsHearingOwnerByHearingId(It.IsAny<int>()))
            .Returns(false);
