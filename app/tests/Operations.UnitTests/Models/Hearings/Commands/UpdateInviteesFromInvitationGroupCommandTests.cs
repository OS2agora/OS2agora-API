...
public class UpdateInviteesFromInvitationGroupCommandTests : ModelsTestBase<UpdateInviteesFromInvitationGroupCommand, MetaDataResponse<Hearing, InvitationMetaData>>
{
    public UpdateInviteesFromInvitationGroupCommandTests()
    {
    ...
    [Test]
    public async Task UpdateInviteesFromInvitationGroup_HearingOwner_Should_Not_Throw_Error()
    {
        SecurityExpressionsMock.Setup(x => x.IsHearingOwnerByHearingId(It.IsAny<int>()))
            .Returns(true);

        var request = new UpdateInviteesFromInvitationGroupCommand();
