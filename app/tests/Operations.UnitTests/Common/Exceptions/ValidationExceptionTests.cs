...
namespace Agora.Operations.UnitTests.Common.Exceptions
{
    public class ValidationExceptionTests
    {
        ...
        [Test]
        public void MultipleValidationFailureForMultipleProperties_CreatesAMultipleElementErrorDictionaryEachWithMultipleValues()
        {
            var failures = new List<ValidationFailure>
            {
