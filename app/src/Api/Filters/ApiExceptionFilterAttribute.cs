...
namespace BallerupKommune.Api.Filters
{
	public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
	{
		...
		public override void OnException(ExceptionContext context)
		{
			...
			_logger.LogError($"OnException caught the following error: {exception.Message}");

			if (exception.InnerException?.Message != null)
			{
				_logger.LogError($"OnException caught the following error (inner): {exception.InnerException.Message}");
			}
