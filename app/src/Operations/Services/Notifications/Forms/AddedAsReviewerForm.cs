...
{
    public class AddedAsReviewerForm : BaseNotificationForm
    {
        public AddedAsReviewerForm(IGlobalContentDao globalContentDao, INotificationContentSpecificationDao notificationContentSpecificationDao, INotificationTypeDao notificationTypeDao, 
        ...
        {
            return GetStandardNotificationContent(hearing, NotificationType.ADDED_AS_REVIEWER);
        }
