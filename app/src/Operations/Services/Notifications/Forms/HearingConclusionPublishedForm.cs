...
{
    public class HearingConclusionPublishedForm : BaseNotificationForm
    {

        public HearingConclusionPublishedForm(IGlobalContentDao globalContentDao, INotificationContentSpecificationDao notificationContentSpecificationDao, INotificationTypeDao notificationTypeDao, 
        ...
        {
            return GetStandardNotificationContent(hearing, NotificationType.HEARING_CONCLUSION_PUBLISHED);
        }
